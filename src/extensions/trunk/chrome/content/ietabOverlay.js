...
IeTab.prototype.ietabContextMenuPopup = function(e) {
	...
	if (popupmenu.hasChildNodes()) {
		...
		if ( menu_source ) {
			...
			menu_dest.addEventListener("command", function(event) {
			    gIeTab.viewPage(event, 0x0003);
			}, false);
